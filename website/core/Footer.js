      ...
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <a
              href="http://stackoverflow.com/questions/tagged/gauzy"
              target="_blank"
              rel="noreferrer noopener">
              Stack Overflow
            </a>
            <a href="https://gitter.im/ever-co/gauzy">Gitter Chat</a>
          ...
          <div>
            ...
            <a href="https://github.com/ever-co/ever-gauzy">GitHub</a>
            <a
              className="github-button"
              href={this.props.config.repoUrl}
              data-icon="octicon-star"
              data-count-href="/ever-co/ever-gauzy/stargazers"
